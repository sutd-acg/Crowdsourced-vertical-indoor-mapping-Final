function [IDX,C,SUMD,K,r,distortion_percent_all]=best_kmeans(X)
...
figure
hold on
distortion_percent_all = distortion_percent(1:9)*100;
plot(distortion_percent_all,'b*--');
hold off

[r,~]=find(distortion_percent>0.9912);
